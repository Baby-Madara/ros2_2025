...
def generate_launch_description():
    ...
    world_file_name               = 'smalltown.world'  # Ignition uses .SDF format for world files
    ...
    declare_simulator_cmd = DeclareLaunchArgument(
        name='headless',
        default_value='False',
        description='Whether to execute Ignition Gazebo GUI')
    ...
    start_ignition_server_cmd = Node(
        package='ros_ign_gazebo',
        executable='ign',
        output='screen',
        arguments=['gazebo', '-r', LaunchConfiguration('world')],
        condition=IfCondition(LaunchConfiguration('use_simulator')))

    start_ignition_client_cmd = Node(
        package='ros_ign_gazebo',
        executable='ign',
        output='screen',
        arguments=['gazebo', '-r', LaunchConfiguration('world')],
    ...
    ld.add_action(start_ignition_client_cmd)
